...
public class DBConstants {
    ...
    public static final String GET_NEXT_PARKING_SPOT = "select min(PARKING_NUMBER) from parking where AVAILABLE = 0 and TYPE = ?";
    ...
    public static final String NUMBER_TICKET_VEHICLE = "select count(VEHICLE_REG_NUMBER) as ticketcounts from ticket where VEHICLE_REG_NUMBER=? and OUT_TIME IS NOT NULL ";
