        ...
        try {
            ...
            if ( vehicleInParking == true) {
                ...
                if (parkingSpot != null && parkingSpot.getId() > 0) {
                    ...
                    boolean isRegular = ticketDAO.checkVehicleIsReg(vehicleRegNumber);
                    if (isRegular == true) {
    ...
    public void processExitingVehicle() {
        try {
            ...
            if (vehicleInParking == true) {
                ...
                System.out.println("the vehicle is not existing in the parking");
            }

        } catch (Exception e) {
            logger.error("the vehicle does not exist in the parking lot", e);
        }
    }
}
